...
<a href="add.php" class="bg-gray-700 hover:bg-gray-600 p-3 text-white rounded">Add New User</a><br/><br/>
...
while($user_data = mysqli_fetch_array($result)) {         
    ...
    echo "<td class='border-2 border-black p-2'><a href='edit.php?id=$user_data[id]'>Edit</a> | <a href='delete.php?id=$user_data[id]'>Delete</a></td></tr>";        
}
?>
</table>
</div>
